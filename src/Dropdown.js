...
function Dropdown(){
    ...
    const getDisplayValue = () => {
        if (false) {
            ...
            return <div className='dropdown-tags'>
                ...
                <input className = 'search-input' value={searchText} onChange={handleChange}></input>
            </div>
        }
    }
    ...
    <div className="dropdown-container">
        <div className="dropdown-input" onClick={() => setShowDropdown(true)}>
